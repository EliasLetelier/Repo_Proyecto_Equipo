document.addEventListener("DOMContentLoaded", () => {
    // ==========================================
    // 1. OBSERVADOR DE SCROLL (A prueba de fallos)
    // ==========================================
    ...
    const observador = new IntersectionObserver((entradas) => {
        ...
        threshold: 0.05, 
        rootMargin: "0px 0px 100px 0px" // Margen positivo para que la animación empiece antes de llegar a la pantalla
    });
    ...
    // Seguro de vida: forzamos a que aparezcan los elementos que ya están en la pantalla al cargar
    setTimeout(() => {
